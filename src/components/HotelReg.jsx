      ...
      <form className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          ...
          <div className="w-full mt-4">
            <label htmlFor="name" className="fonr-medium text-gray-500">
              Hotel Name
            </label>
            <input
              id="name"
          ...
          {/* contact  */}
          <div className="w-full mt-4">
            <label htmlFor="contact" className="fonr-medium text-gray-500">
              Phone
            </label>
            <input
              id="contact"
          ...
          {/* address  */}
          <div className="w-full mt-4">
            <label htmlFor="address" className="fonr-medium text-gray-500">
              Address
            </label>
            <input
              id="address"
